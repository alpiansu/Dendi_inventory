            ...
            <div class="col-md-8">
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        ...
                        <form id="barangForm" action="{{ route('master.barang.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('NamaItem') is-invalid @enderror" id="NamaItem" name="NamaItem" value="{{ old('NamaItem') }}" required>
                                @error('NamaItem')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <select class="form-control @error('JenisBarcode') is-invalid @enderror" name="JenisBarcode[]">
                                            @foreach ($jenisBarcodes as $jenis)
                                                <option value="{{ $jenis->kodeJenis }}">{{ $jenis->JenisBarcode }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-5">
                                        <label for="BarcodeBarang">Nilai Barcode</label>
                                        <input type="text" class="form-control @error('BarcodeBarang') is-invalid @enderror" name="BarcodeBarang[]" required>
                                    </div>
                                    <div class="col-md-2">
                                        <label>Action</label>
